# Hide Menus per User — Odoo 18.0

Bloqueo de módulos por usuario para **Odoo 18.0**. Eliges menús raíz en la ficha del usuario y ese usuario verá esos módulos con listas vacías, sin botones de acción (Nuevo / Editar / Eliminar / Duplicar / Importar / Exportar) y con la creación bloqueada a nivel ORM.

Esta rama es solo para **Odoo 18.0**. Para otras versiones consulta la rama correspondiente (`16.0`, `17.0`, `19.0`).
