...
Per-user module blocking for **Odoo 18.0**. Pick root menus on the user form and that user will see those modules with empty lists, no action buttons (New / Edit / Delete / Duplicate / Import / Export), and creation blocked at the ORM level.

This branch targets **Odoo 18.0** only. For other versions check the matching branch (`16.0`, `17.0`, `19.0`).
